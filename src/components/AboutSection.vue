            ...
            <div class="mt-4 md:mt-0 text-left flex flex-col z-10 h-full" data-aos="flip-right">
                ...
                <div class="grid grid-cols-3 gap-4 max-w-lg pt-8">
                    ...
                    <div class="text-center rounded-xl bg-[#111a3e] shadow-lg border border-[#1f1641] p-3">
                        ...
                        <p class="text-sm sm:text-base text-gray-300">AlpenPro</p>
                    </div>
                </div>
            </div>
        </div>
...
const education=ref([
    {
        ...
        program:'Industrial Engineering and Business Informatics',
        year:'Sep 2019 - Jun 2025'
    },
    {
        id:2,
        School:'Middle School Völs',
